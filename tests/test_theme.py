...
class ThemeTests(unittest.TestCase):
    def test_progressbar_core_light_and_dark_colors_are_used(self) -> None:
        self.assertEqual((LIGHT.window_bg, LIGHT.card_bg), ("#f7f9fc", "#ffffff"))
        self.assertEqual((DARK.window_bg, DARK.card_bg), ("#0b1220", "#111827"))
