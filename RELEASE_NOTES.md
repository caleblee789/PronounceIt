...
- Plays pronunciation automatically when a quick card finishes loading. The Play button repeats it; playback still respects audio availability, the selected audio mode, and the before-answer setting.
- Fits quick cards to their contents, reduces their maximum width and internal spacing, and preserves readable text and viewport bounds for long terms.
